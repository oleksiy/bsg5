...
@Component
class EigthObject extends HasData implements InitializingBean, DisposableBean {
...
public class TestLifecycle07 extends AbstractTestNGSpringContextTests {
    ...
    public void testLifecycleMethods() {
        EigthObject o1 = context.getBean(EigthObject.class);
        assertNotNull(EigthObject.semaphore);
        assertEquals(o1.getDatum(), "default");
        context.close();
        assertNull(EigthObject.semaphore);
    }
}
